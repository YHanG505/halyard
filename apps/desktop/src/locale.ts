...
export const en = {
  ...
  startupFailed: 'DeepSeek Halyard could not start',
  startupLoading: 'Starting DeepSeek Halyard…',
...
export const zh = {
  application: '应用',
  startupFailed: 'DeepSeek Halyard 无法启动',
  startupLoading: '正在启动 DeepSeek Halyard…',
  ...
  updateTitle: 'DeepSeek Halyard 更新',
  ...
  pluginWindowTitle: 'DeepSeek Halyard — 桌面插件',
