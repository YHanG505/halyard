...
const WEB_SEARCH_META = {
  answer: 'DeepSeek Halyard is a plugin-based agent harness on vendored Cordis where **every capability is a plugin**.',
  sources: [
    {
      url: 'https://github.com/deepseek-ai/deepseek-harness',
      title: 'DeepSeek Halyard — plugin-based agent harness',
...
const FIXTURE_SYSTEM_PROMPT = '你是 DeepSeek Halyard 的 fixture 助手。用简洁的中文回答，并在需要时调用工具。'
